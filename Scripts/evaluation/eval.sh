...
#   OUTPUT_DIR=$PROJ_DIR_eval_outputs/$identifier


#   MODEL_NAME=/scratch/bctp/shared/magicoder-checkpoints/merged_models/mistral/eval
...
#     --merged_model_saved_path $MODEL_NAME \
